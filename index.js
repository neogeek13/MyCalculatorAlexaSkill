...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        //welcome message
        let speechText = 'Welcome to My Calculator. You can say, for example, add 2 and 5 or multiply 4 and 8.';
...
const DivisionIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        if (firstNumber && secondNumber) {
            //Perform division
            let result = parseInt(firstNumber) / parseInt(secondNumber);
            result = +result.toFixed(2); //restrict to maximum of 2 decimal places
...
const HelpIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        let speechText = 'You can say, for example, add 3 and 5 or divide 50 by 2.';
